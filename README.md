# Mi Campo Completo V2

Versión integrada y reconstruida de **Mi Campo** para importar de una sola vez en GitHub / Google AI Studio o desplegar como PWA estática.
...
- Si Three.js no puede cargarse: la app sigue funcionando y muestra un fallback visual.
